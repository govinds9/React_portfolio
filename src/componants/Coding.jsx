...
function Coding() {
  ...
  return (
    <div
      ...
      className=" h-full sm:h-screen w-full bg-gradient-to-b from-black via-black to-gray-800  "
    >
      <div className=" max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-screen">
        <div className=" p-8">
          ...
          <p className=" text-white py-6">
            Check out my coding profiles coding practice platform here{" "}
          </p>
        </div>
          ...
          {arr.map(({ id, src, href, name }) => (
            ...
            >
              ...
              <div className=" flex justify-center px-10 font-bold  text-white">
                <button className=" text-2.5xl font-bold hover:scale-105 duration-200 hover:shadow-md shadow-gray-600 m-4 hover:text-blue-400 ">
                  {" "}
