          ...
          <div className="flex flex-col justify-center ">
            <div className=" text-white flex flex-col justify-center h-full">
              ...
              <p className=" text-gray-500 py-4 max-w-md  text-xl ">
                I am Govind Singh skilled front-end developer hailing from Kota,
                Rajasthan. With a passion for web development and a
            ...
            <div>
              <Link
                ...
                smooth
                duration={1000}
                className="group text-white flex flex-row font-bold justify-center items-center bg-gradient-to-r from-cyan-500 to-blue-500 mx-2 cursor-pointer my-2 px-6 py-3 rounded-xl"
              >
